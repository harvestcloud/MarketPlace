...
class LocationController extends Controller
{
    ...
    public function showAction(Location $location)
    {
        ...
        return $this->render('HarvestCloudMarketPlaceProfileBundle:Location:show.html.twig', array(
          'location' => $location,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('HarvestCloudMarketPlaceProfileBundle:Location:new.html.twig', array(
    ...
    public function editAction(Location $location, Request $request)
    {
        ...
        return $this->render('HarvestCloudMarketPlaceProfileBundle:Location:edit.html.twig', array(
          'form'     => $form->createView(),
          'location' => $location,
        ));
    }
